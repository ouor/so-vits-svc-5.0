...
def main(args):
    if (args.ppg == None):
        ...
        os.system(f"{sys.executable} whisper/inference.py -w {args.wave} -p {args.ppg}")

    if (args.vec == None):
        args.vec = "svc_tmp.vec.npy"
        print(f"Auto run : python hubert/inference.py -w {args.wave} -v {args.vec}")
        os.system(f"{sys.executable} hubert/inference.py -w {args.wave} -v {args.vec}")

    if (args.pit == None):
        args.pit = "svc_tmp.pit.csv"
        print(f"Auto run : python pitch/inference.py -w {args.wave} -p {args.pit}")
        os.system(f"{sys.executable} pitch/inference.py -w {args.wave} -p {args.pit}")
